  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="w-9 h-9 rounded-lg bg-[#F8F9FB]/[0.06] border-none cursor-pointer flex items-center justify-center text-base hover:bg-[#F8F9FB]/[0.12] transition-colors relative"
              ...
              visible.slice(0, 20).map(notif => (
                <button
                  ...
                  className={`w-full text-left px-4 py-3 border-b border-white/[0.04] cursor-pointer transition-colors flex gap-3 items-start ${
                    notif.read ? 'bg-transparent hover:bg-[#F8F9FB]/[0.03]' : 'bg-[#F8F9FB]/[0.02] hover:bg-[#F8F9FB]/[0.05]'
                  } border-none`}
                >
                  {/* Unread dot */}
