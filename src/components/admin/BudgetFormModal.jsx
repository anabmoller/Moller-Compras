          ...
          <div>
            <label className="flex items-center gap-2 text-xs font-medium text-slate-400 mb-2 cursor-pointer select-none">
              <input
                ...
                className="w-3.5 h-3.5 accent-[#6B1E2F]"
              />
              Dividir entre establecimientos
            </label>
            {form.splitEnabled && (
              <div className="bg-white/[0.02] rounded-lg border border-white/[0.06] p-3 flex flex-col gap-2">
                    ...
                    {form.splits[est] !== undefined && (
                      <div className="flex items-center gap-1">
                        <input
                          ...
                          className="w-16 px-2 py-1 rounded border border-white/[0.1] bg-white/[0.05] text-xs text-white outline-none text-right"
                          min={0}
                          max={100}
                        />
